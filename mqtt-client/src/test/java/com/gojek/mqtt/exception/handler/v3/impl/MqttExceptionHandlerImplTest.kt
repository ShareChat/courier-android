...
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_BROKER_UNAVAILABLE
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_ALREADY_DISCONNECTED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_CLOSED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_CONNECTED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_DISCONNECTING
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_DISCONNECT_PROHIBITED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_EXCEPTION
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_NOT_CONNECTED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CLIENT_TIMEOUT
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CONNECTION_LOST
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_CONNECT_IN_PROGRESS
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_FAILED_AUTHENTICATION
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_INVALID_CLIENT_ID
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_INVALID_MESSAGE
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_INVALID_PROTOCOL_VERSION
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_MAX_INFLIGHT
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_NOT_AUTHORIZED
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_NO_MESSAGE_IDS_AVAILABLE
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_SERVER_CONNECT_ERROR
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_SOCKET_FACTORY_MISMATCH
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_SSL_CONFIG_ERROR
import `in`.mohalla.phao.client.mqttv3.MqttException.REASON_CODE_TOKEN_INUSE
...
class MqttExceptionHandlerImplTest {
    ...
    fun `test exception with reason code 3`() {
        val exception = MqttException(
            REASON_CODE_BROKER_UNAVAILABLE.toInt()
        )
