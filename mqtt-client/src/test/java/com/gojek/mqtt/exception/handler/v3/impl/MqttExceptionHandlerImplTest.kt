...
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_CLOSED
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_CONNECTED
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_DISCONNECTING
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_DISCONNECT_PROHIBITED
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_EXCEPTION
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_NOT_CONNECTED
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CLIENT_TIMEOUT
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_CONNECTION_LOST
...
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_NOT_AUTHORIZED
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_NO_MESSAGE_IDS_AVAILABLE
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_SERVER_CONNECT_ERROR
import `in`.mohalla.paho.client.mqttv3.MqttException.REASON_CODE_SOCKET_FACTORY_MISMATCH
