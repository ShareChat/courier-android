 ...
 */
package in.mohalla.phao.client.mqttv3.internal.websocket;
...
public class WebSocketSecureNetworkModule extends SSLNetworkModule{
	...
	public WebSocketSecureNetworkModule(SSLSocketFactory factory, String uri, String host, int port, String clientId, ILogger logger, IPahoEvents pahoEvents) {
		super(factory, host, port, clientId, logger, pahoEvents);
		this.uri = uri;
		this.host = host;
		this.port = port;
		this.logger = logger;
