 ...
 */
package in.mohalla.phao.client.mqttv3.internal.wire;
...
public abstract class MqttWireMessage
{
	...
	public static MqttWireMessage createWireMessage(MqttPersistable data, String mqttVersion) throws MqttException
	{
		...
		MultiByteArrayInputStream mbais = new MultiByteArrayInputStream(data.getHeaderBytes(), data.getHeaderOffset(), data.getHeaderLength(), payload, data.getPayloadOffset(),
