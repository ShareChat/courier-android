		...
		if (INSTANCE == null)
		{
			if (ExceptionHelper.isClassAvailable("java.util.ResourceBundle"))
			{
				try
				{
					...
					INSTANCE = (MessageCatalog) Class.forName(
                            "in.mohalla.phao.client.mqttv3.internal.ResourceBundleCatalog").newInstance();
				}
				catch (Exception e)
				{
					return "";
			...
			else if (ExceptionHelper.isClassAvailable("in.mohalla.phao.client.mqttv3.internal.MIDPCatalog"))
			{
				try
				{
					INSTANCE = (MessageCatalog) Class.forName(
                            "in.mohalla.phao.client.mqttv3.internal.MIDPCatalog").newInstance();
				}
				catch (Exception e)
				{
					return "";
